...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'menu.update': { roles: ['owner'], key: 'chef-menu-update', tenantPath: ['restaurant', 'menu'], userPath: [] },
  'reservation.create': {
    roles: ['owner', 'chef'],
    key: 'guest-new-reservation',
    tenantPath: ['restaurant', 'reservation'],
    userPath: [],
  },
  'reservation.update': {
    roles: ['owner', 'chef'],
    key: 'guest-reservation-update',
    tenantPath: ['restaurant', 'reservation'],
    userPath: [],
  },
};
